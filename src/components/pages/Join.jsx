    ...
    <div className="m-4">
      ...
      <div className="justify-center">
        {JoinForm.map((input, key) => {
          return (
            <div key={key}>
              <label className="font-bold pt-6 pb-2 block">{input.label}</label>
              <input
        ...
        <div className="pt-24">
          <button
            className="w-full h-12 text-indigo-100 text-xl font-bold transition-colors duration-150 bg-blue-500 rounded-lg focus:shadow-outline hover:bg-indigo-800"
            type="submit"
          >
            회원가입
          </button>
